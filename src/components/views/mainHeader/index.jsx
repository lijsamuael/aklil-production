...
export default function MainHeader() {
  return (
    <div className="pt-40 flex flex-col justify-between  h-screen bg-gradient-to-t from-primary-white to-primary-yellow font-mono">
      <div className="flex max-w-[1500px] mx-auto justify-center  h-3/5 items-center gap-x-16">
        ...
        <div className="flex w-3/5 h-full mt-32">
          <div className="">
            <img className="w-full h-full rounded-2xl" src="/images/mainImage.png" alt="" />
          </div>
        </div>
      </div>
